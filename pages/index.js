...
export default () => {
  ...
  return (
    <>
      <Header />
      <div className={cx(layout.container, global.header_margin)} id="container">
        ...
        <Swoosh id="mv1" startElement={firstRef} endElement={secondRef} />
        ...
        <Swoosh id="mv2" startElement={thirdRef} endElement={fourthRef} />
        ...
        <Swoosh id="mv3" startElement={fifthRef} endElement={sixthRef} />
